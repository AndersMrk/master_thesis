...
% endpoints 0 and L
\draw[tick] (0,\yAxis-0.10) -- (0,\yAxis+0.10) node[right=-7pt, yshift=8pt,text=AxisColor] {$0 \to h_{0}$};
\draw[tick] (\Lpipe,\yAxis-0.10) -- (\Lpipe,\yAxis+0.10) node[right=-7pt, yshift=8pt,text=AxisColor] {$\ell \to h_{\ell}$};
...
\newcommand{\LeakAt}[2]{%
  ...
  \draw[tick] (#1,\yAxis-0.10) -- (#1,\yAxis+0.10)
    node[right=-7pt, yshift=8pt, text=AxisColor] {$z_{#2} \to h_{#2}$};
}
...
\FlowInSegment{\zN}{\zN+2*\flowlen}{q_{\ell}}
