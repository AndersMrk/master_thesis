...
% ---- Geometry ----
\def\xo{2}
\def\Lpipe{8}      % visual length representing [0, L]
\def\yPipe{0}
\def\yAxis{1.2}
...
% ---- Z-axis above pipe ----
\draw[axis,->] (\xo-0.6,\yAxis) -- (\xo+\Lpipe+0.6,\yAxis) node[right] {$z$-axis};
...
\FlowInSegment{\zIm-2}{\zIm}{q_{i-2}}
\FlowInSegment{\zIm}{\zI}{q_{i-1}}
\FlowInSegment{\zI}{\zIp}{q_i}
\FlowInSegment{\zIp}{\zIp+2}{q_{i+1}}
