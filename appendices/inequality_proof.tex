...
operating point $\{h_0,h_{\ell},q_0,q_{\ell}\}$.\\
...
It remains to satisfy the leak laws at $z_2$ and $z_1$. Since $\tilde{q}_{2}$ and $\tilde{q}_{1}$ are fixed by
$(q_0,q_1,q_2,q_{\ell})$, the leak laws at $z_2$ and $z_1$ are equivalent to the compatibility constraints
\begin{align}
...
(e.g., they can be enforced by adjusting the boundary conditions $q_0$ and/or $q_{\ell}$).
Whenever these compatibilities hold, the constructed $\{h_0,h_{\ell},q_0,q_{\ell}\}$ is a valid steady state
